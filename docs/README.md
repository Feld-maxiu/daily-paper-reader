...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-25 22:02:52 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Learning from Failures: Heterogeneous Graph Memory for Small Language Model Tool-Using Agents》（10.0/10）, 《Agent-Editing World Model: Rethinking World Modeling for LLM Agents》（10.0/10）</p>
<p>速读：《Adversarial Closed-Loop Curriculum for Evolving Role-Playing Agents》（8.0/10）, 《OmniFysics-Nano-V2 Technical Report: Understanding the Physical World Across Modalities》（7.0/10）, 《World Action Agent: Harnessing VLMs for Robot Manipulation via World Action Rehearsal》（7.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Learning from Failures: Heterogeneous Graph Memory for Small Language Model Tool-Using Agents">Learning from Failures: Heterogeneous Graph Memory for Small Language Model Tool-Using Agents</span></li><li><span class="dpr-home-dashboard-paper-title" title="Agent-Editing World Model: Rethinking World Modeling for LLM Agents">Agent-Editing World Model: Rethinking World Modeling for LLM Agents</span></li><li><span class="dpr-home-dashboard-paper-title" title="Memory Control Signals Emerge Before Action in Long Horizon Agents">Memory Control Signals Emerge Before Action in Long Horizon Agents</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Adversarial Closed-Loop Curriculum for Evolving Role-Playing Agents">Adversarial Closed-Loop Curriculum for Evolving Role-Playing Agents</span></li><li><span class="dpr-home-dashboard-paper-title" title="OmniFysics-Nano-V2 Technical Report: Understanding the Physical World Across Modalities">OmniFysics-Nano-V2 Technical Report: Understanding the Physical World Across Modalities</span></li><li><span class="dpr-home-dashboard-paper-title" title="World Action Agent: Harnessing VLMs for Robot Manipulation via World Action Rehearsal">World Action Agent: Harnessing VLMs for Robot Manipulation via World Action Rehearsal</span></li></ul>
  </div>
