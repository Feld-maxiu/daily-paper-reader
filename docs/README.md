...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-22 20:32:51 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Can Agent Memory Systems Track Evolving State?》（9.0/10）</p>
<p>速读：《Looped Language Models Improve Compositional Tool Calling》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Can Agent Memory Systems Track Evolving State?">Can Agent Memory Systems Track Evolving State?</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Looped Language Models Improve Compositional Tool Calling">Looped Language Models Improve Compositional Tool Calling</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">agent-memory <strong>1</strong></span></div>
</section>
</div>
