...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-26 22:12:57 UTC<br>状态：成功</p>
</section>
...
<p>精读：《GSAR: Goal-State-Anchor Rewards for Mobile GUI Agents with Self-Evolving Data Synthesis》（9.0/10）, 《Dual-Grained Agent Memory and Shapley Context Attribution for Multimodal Agentic Learner》（9.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="GSAR: Goal-State-Anchor Rewards for Mobile GUI Agents with Self-Evolving Data Synthesis">GSAR: Goal-State-Anchor Rewards for Mobile GUI Agents with Self-Evolving Data Synthesis</span></li><li><span class="dpr-home-dashboard-paper-title" title="Dual-Grained Agent Memory and Shapley Context Attribution for Multimodal Agentic Learner">Dual-Grained Agent Memory and Shapley Context Attribution for Multimodal Agentic Learner</span></li><li><span class="dpr-home-dashboard-paper-title" title="Sparse Multi-Stage Expert-Agent Routing for Complex Clinical Reasoning">Sparse Multi-Stage Expert-Agent Routing for Complex Clinical Reasoning</span></li></ul>
  </div>
