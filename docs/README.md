...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-21 22:34:04 UTC<br>状态：成功</p>
</section>
...
<p>精读：《BirdsongChat: A Hybrid Multi-Agent Framework for Multimodal Embodied Behavior Simulation》（9.0/10）, 《MintAct: A Unified Visual Agent for Digital Environments》（9.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="BirdsongChat: A Hybrid Multi-Agent Framework for Multimodal Embodied Behavior Simulation">BirdsongChat: A Hybrid Multi-Agent Framework for Multimodal Embodied Behavior Simulation</span></li><li><span class="dpr-home-dashboard-paper-title" title="MintAct: A Unified Visual Agent for Digital Environments">MintAct: A Unified Visual Agent for Digital Environments</span></li><li><span class="dpr-home-dashboard-paper-title" title="AgentVidBench: A Multi-Hop Video Question Answering Benchmark for Evaluating MLLM Agents">AgentVidBench: A Multi-Hop Video Question Answering Benchmark for Evaluating MLLM Agents</span></li></ul>
  </div>
