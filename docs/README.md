...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-02 23:03:30 UTC<br>状态：成功</p>
</section>
...
<p>今日共生成 8 篇推荐（精读 4 篇，速读 4 篇）</p>
<p>精读：《Towards a Belief-Based World Model for LLM Agents》（9.0/10）, 《World Model-Guided Reinforcement Learning via Counterfactual User Engagement Simulation》（9.0/10）</p>
<p>速读：《GUI-CC: Benchmarking Contextual Consistency of GUI World Models as Agent Environments》（7.0/10）, 《WorldBench: Culturally Grounded Benchmark for Multilingual Agents》（7.0/10）, 《The Rise of Verbal Reinforcement Learning》（7.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Towards a Belief-Based World Model for LLM Agents">Towards a Belief-Based World Model for LLM Agents</span></li><li><span class="dpr-home-dashboard-paper-title" title="World Model-Guided Reinforcement Learning via Counterfactual User Engagement Simulation">World Model-Guided Reinforcement Learning via Counterfactual User Engagement Simulation</span></li><li><span class="dpr-home-dashboard-paper-title" title="Classic AI Scaffolding for LLM Social Agents">Classic AI Scaffolding for LLM Social Agents</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="GUI-CC: Benchmarking Contextual Consistency of GUI World Models as Agent Environments">GUI-CC: Benchmarking Contextual Consistency of GUI World Models as Agent Environments</span></li><li><span class="dpr-home-dashboard-paper-title" title="WorldBench: Culturally Grounded Benchmark for Multilingual Agents">WorldBench: Culturally Grounded Benchmark for Multilingual Agents</span></li><li><span class="dpr-home-dashboard-paper-title" title="The Rise of Verbal Reinforcement Learning">The Rise of Verbal Reinforcement Learning</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">agent-memory <strong>4</strong></span></div>
</section>
</div>
