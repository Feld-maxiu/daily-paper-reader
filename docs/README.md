...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-16 19:32:01 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Discovering Diverse Planning Policies for Multimodal Embodied Agents with Quality-Diversity Optimization》（9.0/10）, 《HarnessWAM: Bridging Prediction and Deliberation in World Action Models》（8.0/10）</p>
<p>速读：《Rethink Before You Execute: Adaptive Execution for World Action Models》（7.0/10）, 《Population-Scalable Multi-Agent World Modeling》（6.0/10）, 《A Unifying Perspective on Causal World Models: From Observations to Representations to Structure》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Discovering Diverse Planning Policies for Multimodal Embodied Agents with Quality-Diversity Optimization">Discovering Diverse Planning Policies for Multimodal Embodied Agents with Quality-Diversity Optimization</span></li><li><span class="dpr-home-dashboard-paper-title" title="HarnessWAM: Bridging Prediction and Deliberation in World Action Models">HarnessWAM: Bridging Prediction and Deliberation in World Action Models</span></li><li><span class="dpr-home-dashboard-paper-title" title="TideRL: Boosting Agentic RL Goodput with Readiness-Aware Scheduling">TideRL: Boosting Agentic RL Goodput with Readiness-Aware Scheduling</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Rethink Before You Execute: Adaptive Execution for World Action Models">Rethink Before You Execute: Adaptive Execution for World Action Models</span></li><li><span class="dpr-home-dashboard-paper-title" title="Population-Scalable Multi-Agent World Modeling">Population-Scalable Multi-Agent World Modeling</span></li><li><span class="dpr-home-dashboard-paper-title" title="A Unifying Perspective on Causal World Models: From Observations to Representations to Structure">A Unifying Perspective on Causal World Models: From Observations to Representations to Structure</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">agent-memory <strong>3</strong></span></div>
</section>
</div>
