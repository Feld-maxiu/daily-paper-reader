...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-09 22:15:19 UTC<br>状态：成功</p>
</section>
...
<p>精读：《EnvCraft: Synthesizing Executable Environments in Agentic RL for Claw-like Agent》（9.0/10）, 《SerenAI: State-transition system inspired by text-based world AI models》（9.0/10）</p>
<p>速读：《WorldAgen: Unified State-Action Prediction with Test-Time World Model Training》（8.0/10）, 《Experience Funnel: A State-Policy Alternating Loop for Self-Evolving Agents》（8.0/10）, 《Procedural Graphs: Self-Evolving Execution Structures for LLM Agents》（7.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="EnvCraft: Synthesizing Executable Environments in Agentic RL for Claw-like Agent">EnvCraft: Synthesizing Executable Environments in Agentic RL for Claw-like Agent</span></li><li><span class="dpr-home-dashboard-paper-title" title="SerenAI: State-transition system inspired by text-based world AI models">SerenAI: State-transition system inspired by text-based world AI models</span></li><li><span class="dpr-home-dashboard-paper-title" title="MEMO: Multimodal Evidence Memory Organization for Long-Horizon LLM Agents">MEMO: Multimodal Evidence Memory Organization for Long-Horizon LLM Agents</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="WorldAgen: Unified State-Action Prediction with Test-Time World Model Training">WorldAgen: Unified State-Action Prediction with Test-Time World Model Training</span></li><li><span class="dpr-home-dashboard-paper-title" title="Experience Funnel: A State-Policy Alternating Loop for Self-Evolving Agents">Experience Funnel: A State-Policy Alternating Loop for Self-Evolving Agents</span></li><li><span class="dpr-home-dashboard-paper-title" title="Procedural Graphs: Self-Evolving Execution Structures for LLM Agents">Procedural Graphs: Self-Evolving Execution Structures for LLM Agents</span></li></ul>
  </div>
