...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-19 21:13:10 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Acting in Meters: Learning Metric Interactions for Precise Robotic Manipulation》（8.0/10）</p>
<p>速读：《FluxVLA Engine: A One-Stop VLA Engineering Platform for Embodied Intelligence》（7.0/10）, 《AURORA: A Natural Language-Driven Agentic Framework for Understanding, Reasoning, and Orchestrating Reliable Air-Ground Co-Simulation》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Acting in Meters: Learning Metric Interactions for Precise Robotic Manipulation">Acting in Meters: Learning Metric Interactions for Precise Robotic Manipulation</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="FluxVLA Engine: A One-Stop VLA Engineering Platform for Embodied Intelligence">FluxVLA Engine: A One-Stop VLA Engineering Platform for Embodied Intelligence</span></li><li><span class="dpr-home-dashboard-paper-title" title="AURORA: A Natural Language-Driven Agentic Framework for Understanding, Reasoning, and Orchestrating Reliable Air-Ground Co-Simulation">AURORA: A Natural Language-Driven Agentic Framework for Understanding, Reasoning, and Orchestrating Reliable Air-Ground Co-Simulation</span></li></ul>
  </div>
