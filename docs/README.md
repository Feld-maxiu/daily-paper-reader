...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-15 20:29:22 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Bidirectional Context Self-Distillation for Reinforcement Learning of Skill-Based LLM Agents》（10.0/10）, 《IB-RL: Isolated Bilateral Reinforcement Learning for Strategic Dialogue Agents》（9.0/10）</p>
<p>速读：《Self-Evolving Embodied Agents via Skill-Harness Evolution》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Bidirectional Context Self-Distillation for Reinforcement Learning of Skill-Based LLM Agents">Bidirectional Context Self-Distillation for Reinforcement Learning of Skill-Based LLM Agents</span></li><li><span class="dpr-home-dashboard-paper-title" title="IB-RL: Isolated Bilateral Reinforcement Learning for Strategic Dialogue Agents">IB-RL: Isolated Bilateral Reinforcement Learning for Strategic Dialogue Agents</span></li></ul>
  </div>
